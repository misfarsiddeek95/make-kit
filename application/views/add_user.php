              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" id="inputmasks">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" value="<?php if(!(empty($user))){echo($user->nic);} ?>" placeholder="National Identity Card"  id="nic" name="nic" class="form-control" data-minlength="10" data-error="Please enter a valid NIC number" data-required-error="NIC is Required" required>
                    <div class="help-block with-errors"></div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" data-plugin="select2" name="visibleSites[]" id="visibleSites" multiple="multiple" data-placeholder="Visible Websites">
                      ...
                      <?php foreach ($websites as $row) { 
                        $selt='';
                        if(!(empty($user))){
                          if(in_array($row->ws_id ,$staff_sites)){
                            $selt='selected';
                          }
                        }else{
                          $selt='selected';
