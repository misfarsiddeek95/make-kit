                                        ...
                                        <table class="table table-hover this-table">
                                            ...
                                            <tbody class="tbody_data">
                                                ...
                                                <tr id="rowId<?=$pp->paper_id?>" class="table-row">
                                                    <td style="width: 5%;"><i class="zmdi zmdi-long-arrow-tab"></i></td>
                                                    ...
                                                    <td align="right">
                                                        <?php if($view){ ?>
                                                        <a class="btn btn-outline-warning btn-sm btn-pill m-r-5" href="<?=base_url()?>view-paper/<?=base64_encode($pp->paper_id);?>"><i class="zmdi zmdi-eye"></i></a>
                                                        <?php }if($edit){ ?>
                                                        <a class="btn btn-outline-primary btn-sm btn-pill m-r-5" href="<?=base_url()?>edit-paper/<?=base64_encode($pp->paper_id);?>"><i class="zmdi zmdi-edit"></i></a>
                                                        <?php }if($delete){ ?>
                                                        <button type="button" class="btn btn-outline-danger btn-sm btn-pill m-r-5" onclick="deleteMe('<?=$pp->paper_id?>');"><i class="zmdi zmdi-delete"></i></button>
                                                        <?php } ?>
                                                    </td>
                                                    <?php } ?>
                                                </tr>
                            ...
                            if (resp.status == 'success') {
                                ...
                                if (resp.last_added != false && jQuery.isEmptyObject(resp.last_added) == false) {
                                    ...
                                    tr = `<tr id="rowId${data.paper_id}" class="table-row">
                                            ...
                                            <td align="right">
                                                <?php if($view){ ?>
                                                <a class="btn btn-outline-warning btn-sm btn-pill m-r-5" href="<?=base_url()?>view-paper/${btoa(data.paper_id)}"><i class="zmdi zmdi-eye"></i></a>
                                                <?php }if($edit){ ?>
                                                <a class="btn btn-outline-primary btn-sm btn-pill m-r-5" href="<?=base_url()?>edit-paper/${btoa(data.paper_id)}"><i class="zmdi zmdi-edit"></i></a>
                                                <?php }if($delete){ ?>
                                                <button type="button" class="btn btn-outline-danger btn-sm btn-pill m-r-5" onclick="deleteMe('${data.paper_id}');"><i class="zmdi zmdi-delete"></i></button>
                                                <?php } ?>
                                            </td>
                                            <?php } ?>
                                        </tr>`;
